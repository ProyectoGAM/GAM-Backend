...
use Database\Factories\ManagementPlans\PlanTemplateActivityFactory;
 ...
 */
class PlanTemplateActivity extends Model
{
    /** @use HasFactory<PlanTemplateActivityFactory> */
    use HasFactory;

    /** @return BelongsTo<PlanTemplateVersion, $this> */
    public function version(): BelongsTo
    {
        return $this->belongsTo(PlanTemplateVersion::class, 'plan_template_version_id');
    }
